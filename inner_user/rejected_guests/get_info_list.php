<?php
	...
	$sql_cnt = "select count(*) from guests where chk_status=100";
	$sql_data = "select a.guest_id guest_id,a.login_name login_name,a.reg_date reg_date,a.sheng_id sheng_id,a.shi_id shi_id,a.xian_id xian_id,a.family_name family_name,a.given_name given_name,a.company company,a.duty duty,a.phone phone,a.phone2 phone2,a.address address,CONCAT(c.sheng_name,d.shi_name,e.xian_name) area_name from guests a,areas_sheng c,areas_shi d,areas_xian e where a.chk_status=100 and c.sheng_id=a.sheng_id and d.shi_id=a.shi_id and e.xian_id=a.xian_id order by a.login_name limit $offset,$rows";
